        ...
        <div class="bottom-footer">
          ...
          <div class="info-item" v-for="item in $store.state.settings.footer_info" :key="item.id">
            <div class="social-icons">
              ...
              <a href="https://www.linkedin.com/company/grand-garage®" class="social-icon" target="_blank">
                <img src="~/assets/img/icons/linkedin.png" class="icon-linkedin" data-icon="linkedin">
              </a>
            </div>
            <h4>{{item.headline}}</h4>
